---
title: "Малогабаритный контроллер двигателя на постоянных магнитах"
fullName: " "
date: 2024-01-01
draft: false
weight: 10
  ...
  <div id="utudCarousel" class="carousel slide carousel-dark" data-bs-ride="carousel" data-bs-interval="5000" style="cursor: pointer;">
    <div class="carousel-inner rounded" style="height: 250px;">
      <div class="carousel-item active" style="height: 250px;" data-bs-toggle="modal" data-bs-target="#imageModal" data-img="/tm-hugo/img/products/ ">
        <img src="/tm-hugo/img/products/    " class="d-block w-100 h-100 rounded" style="object-fit: contain;" alt="    ">
      </div>
    </div>
  </div>
...
<div class="row g-4 mb-4">
  <div class="col-md-6">
    <div class="card h-100 border-0 shadow-sm">
      <div class="card-body">
        <h6 class="fw-bold text-danger mb-2"> ___ </h6>
        <p class="small"> ___ </p>
      </div>
    </div>
  </div>
