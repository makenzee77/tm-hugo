  ...
  <div id="bkuCarousel" class="carousel slide carousel-dark" data-bs-ride="carousel" data-bs-interval="5000">
    ...
    <div class="carousel-inner rounded">
      <div class="carousel-item active">
        <img src="/tm-hugo/img/products/rotation2.png" class="d-block w-100 rounded" alt="БКУ-ПТЗ - общий вид">
      </div>
      <div class="carousel-item">
        <img src="/tm-hugo/img/products/rotation3.png" class="d-block w-100 rounded" alt="БКУ-ПТЗ - установка">
      </div>
      <div class="carousel-item">
        <img src="/tm-hugo/img/products/rotation4.png" class="d-block w-100 rounded" alt="БКУ-ПТЗ - установка">
      </div>
    </div>
