  ...
  <div id="bkuCarousel" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner rounded">
      <div class="carousel-item active">
        <img src="/tm-hugo/img/products/Speedsensor.png" class="d-block w-100" alt="БКУ фронт">
      </div>
      <div class="carousel-item">
        <img src="/tm-hugo/img/products/sensor_speed_2.jpg" class="d-block w-100" alt="БКУ бок">
      </div>
    </div>
